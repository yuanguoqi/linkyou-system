export default {
  ...
  settings: {
    ...
    requireConfirmedEmail: 'Require Email Verification',
    requireConfirmedPhone: 'Require Phone Verification',
    passwordRequiredLength: 'Required Password Length',
    passwordRequireNonAlphanumeric: 'Require Non-Alphanumeric',
    passwordRequireLowercase: 'Require Lowercase',
    passwordRequireUppercase: 'Require Uppercase',
    passwordRequireDigit: 'Require Digit',
    selfRegistration: 'Enable Self Registration',
    userLockoutEnabled: 'Enable User Lockout',
    maxFailedLoginAttempts: 'Max Failed Login Attempts',
    lockoutDurationSeconds: 'Lockout Duration (Seconds)',
    maxUserCountPerOrgUnit: 'Max Users Per Org Unit',
    catLocalization: 'Localization',
    catTiming: 'Timing',
    catIdentity: 'Identity',
    catAccount: 'Account',
    catSettingManagement: 'Setting Management',
    catTenantManagement: 'Tenant Management',
    catFeatureManagement: 'Feature Management',
    catPermissionManagement: 'Permission Management',
    catPassword: 'Password Policy',
    catSignIn: 'Sign In',
    catLockout: 'Lockout',
    catOrganizationUnit: 'Organization Unit',
    enabled: 'Enabled',
    disabled: 'Disabled',
  },
}
