export default {
  ...
  settings: {
    ...
    requireConfirmedEmail: '登录需要验证邮箱',
    requireConfirmedPhone: '登录需要验证手机号',
    passwordRequiredLength: '密码要求长度',
    passwordRequireNonAlphanumeric: '要求非字母数字',
    passwordRequireLowercase: '要求小写字母',
    passwordRequireUppercase: '要求大写字母',
    passwordRequireDigit: '要求数字',
    selfRegistration: '启用自助注册',
    userLockoutEnabled: '启用用户锁定',
    maxFailedLoginAttempts: '最大登录失败次数',
    lockoutDurationSeconds: '锁定持续时间(秒)',
    maxUserCountPerOrgUnit: '组织单元最大用户数',
    catLocalization: '本地化',
    catTiming: '时间',
    catIdentity: '身份管理',
    catAccount: '账户管理',
    catSettingManagement: '设置管理',
    catTenantManagement: '租户管理',
    catFeatureManagement: '功能管理',
    catPermissionManagement: '权限管理',
    catPassword: '密码策略',
    catSignIn: '登录设置',
    catLockout: '锁定策略',
    catOrganizationUnit: '组织单元',
    enabled: '启用',
    disabled: '禁用',
  },
}
